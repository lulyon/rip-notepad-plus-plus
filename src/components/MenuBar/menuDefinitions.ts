...
export const MENU_STRUCTURE: MenuDef[] = [
  {
    ...
    children: [
      ...
      S(),
      { id: "file.saveWorkspace", labelKey: "menu.file.saveWorkspace" },
      { id: "file.loadWorkspace", labelKey: "menu.file.loadWorkspace" },
      S(),
      ...
      { id: "file.syncSettings", labelKey: "menu.file.syncSettings" },
      S(),
