const zh = {
  translation: {
    ...
    "search.inSelection": "选中范围内",
    "search.preview": "预览",
    "search.previewTitle": "替换预览 — {{count}} 处",
    ...
    // ── Sync ──
    "preferences.sync": "同步",
    "preferences.sync.provider": "服务商",
    "preferences.sync.providerGist": "GitHub Gist (个人访问令牌)",
    "preferences.sync.providerDropbox": "Dropbox (即将推出)",
    "preferences.sync.providerGoogle": "Google Drive (即将推出)",
    "preferences.sync.patLabel": "个人访问令牌",
    "preferences.sync.patHelp": "在 github.com/settings/tokens 创建令牌，授权 \"gist\" 范围",
    "preferences.sync.testConnection": "测试连接",
    "preferences.sync.testSuccess": "连接成功",
    "preferences.sync.testFailed": "连接失败",
    "preferences.sync.export": "导出到云端",
    "preferences.sync.import": "从云端导入",
    "preferences.sync.lastSync": "上次同步：{{time}}",
    "preferences.sync.never": "从未",
    "preferences.sync.exporting": "正在导出...",
    "preferences.sync.importing": "正在导入...",
    "preferences.sync.success": "同步完成",
    "preferences.sync.failed": "同步失败：{{error}}",
    "preferences.sync.confirmImport": "导入将覆盖当前设置。继续？",
    "preferences.sync.confirmExport": "导出将覆盖云端数据。继续？",
    "preferences.sync.noToken": "请先输入个人访问令牌",
    "preferences.sync.noGist": "请先导出到云端以创建同步文件",
    ...
    "run.variables": "变量",
    "run.clear": "清空",
    "run.var.fullpath": "完整路径",
    "run.var.fullpathDesc": "当前文件完整路径",
    "run.var.dir": "当前目录",
    "run.var.dirDesc": "当前文件所在目录",
    "run.var.filename": "文件名",
    "run.var.filenameDesc": "含扩展名的文件名",
    "run.var.namepart": "主文件名",
    "run.var.namepartDesc": "不含扩展名的文件名",
    "run.var.extpart": "扩展名",
    "run.var.extpartDesc": "文件扩展名",
    "run.var.word": "当前词",
    "run.var.wordDesc": "光标所在位置的单词",
    "run.var.line": "行号",
    "run.var.lineDesc": "当前光标行号",
    "run.var.column": "列号",
    "run.var.columnDesc": "当前光标列号",
    "run.var.projectroot": "项目根目录",
    "run.var.projectrootDesc": "当前打开的项目文件夹",
    "run.var.nppdir": "应用目录",
    "run.var.nppdirDesc": "应用目录",
    ...
    "git.checkoutFailed": "切换分支失败：{{error}}",
    "git.newBranch": "新分支名...",

    // ── Commit Dialog ──
    "commit.title": "提交更改",
    "commit.filesStaged": "{{count}} 个文件已暂存",
    "commit.messagePlaceholder": "提交信息 (Enter 提交，Shift+Enter 换行)",
    ...
    "tools.cwd": "工作目录（空 = 项目根目录）",
    "tools.shortcut": "快捷键（例如 Ctrl+Shift+1）",
    "tools.update": "更新",
    "tools.add": "添加",
    "tools.cancel": "取消",
    "tools.variables": "变量：",
