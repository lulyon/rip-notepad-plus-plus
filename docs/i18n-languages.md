...
```
┌──────┬───────────────────────────────────────┬──────┬──────────┬──────────────┐
│  #   │              Language                 │ Code │  Source  │   Speakers   │
├──────┼───────────────────────────────────────┼──────┼──────────┼──────────────┤
│    1 │ 中文 (简体)                           │  zh  │ Existing │ 1.4B         │
│    2 │ English                               │  en  │ Existing │ 1.5B         │
│    3 │ 日本語                                │  ja  │ Existing │ 125M         │
│    4 │ 한국어                                │  ko  │ Existing │ 81M          │
│    5 │ Français                              │  fr  │ Existing │ 320M         │
│    6 │ العربية                               │  ar  │ Existing │ 370M      ✨ │
│    7 │ עברית                                 │  he  │ Existing │ 9M         ✨ │
├──────┼───────────────────────────────────────┼──────┼──────────┼──────────────┤
│    8 │ Deutsch                               │  de  │ VS Code  │ 130M         │
│    9 │ Español                               │  es  │ VS Code  │ 500M         │
│   10 │ Português                             │  pt  │ VS Code  │ 260M         │
│   11 │ Русский                               │  ru  │ VS Code  │ 260M         │
│   12 │ Italiano                              │  it  │ VS Code  │ 67M          │
│   13 │ Türkçe                                │  tr  │ VS Code  │ 88M          │
│   14 │ Polski                                │  pl  │ VS Code  │ 40M          │
